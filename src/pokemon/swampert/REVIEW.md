...
- [x] `entrance`: coiled low with the arms swung back, it springs (launch) gathering speed, the legs driving straight and both arms thrown up and open like a breach; at the top the knees come up in front of the belly while the arms wind up high; the feet reach down and touch down (land), then it drops like a boulder: the knees sink deep and both arms slam down flat in front to catch its weight, the fins and tail fan bouncing on their springs; it squashes onto its arms, rebounds, pushes itself up off the ground glaring at the foe and rises into the stance (1.95 s, 0.5 s from launch to land). Reviewed on sheets bursting out of the tall grass (at first only the fin tips and the hands break the grass, then the open-mouthed head with the arms flung up), dropping off the ceiling (cave: the feet come into view first, the arms slam down as it lands) and drifting down to the seabed (at 0.6 speed the slam reads as settling heavily into the sand), and filmed in the battle intro in grass, on the sea, in the cave and on the seabed
  - fixed after review: the first landing laid the body flat (a belly flop: a deep crouch plus a spine bend on a body that already leans forward); now the torso stays up and the arms take the weight. The tuck splayed the legs out like a frog's; now the knees come up in front of the belly. The squash began before touchdown (a pop on the head and chest in mid-air); now it touches down on `land` and sinks after, and the spring is no longer a snap that stalls before the launch (0 stop-starts, 0 pops: Blaziken's has 5 pops)
...
dead holds over 15.7 s (`entrance`, `intro`, `hit`, `faint`, `afterimage`,
