...
- [x] `physical_weak`: Slash — wind-up with the claw cocked, leaps in along an arc, lands into a knee bend, slashes across, claw follows through, hops home
- [x] `physical_strong`: Blaze Kick — coils turned away, springs up, side-on kick at the top of the arc, full spin, lands deep, hops home
